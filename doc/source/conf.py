...
linkcheck_ignore = [
    'https://github.com/ansys/scade-python-wrapper',
    'https://github.com/ansys/scade-python-wrapper/actions/workflows/ci_cd.yml',
    'https://pypi.org/project/ansys-scade-python-wrapper',
